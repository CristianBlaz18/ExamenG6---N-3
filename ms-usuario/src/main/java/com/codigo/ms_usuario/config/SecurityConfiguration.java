    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(request -> request
                        .requestMatchers(Constants.ENPOINTS_SIGNUP_ADMIN).permitAll()
                        .requestMatchers(Constants.ENPOINTS_SIGNUP_USER).permitAll()
                        .requestMatchers(Constants.ENPOINTS_PERMIT_LOGIN).permitAll()
                        .requestMatchers(Constants.ENPOINTS_NO_PERMITE).authenticated()
